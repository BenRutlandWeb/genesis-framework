...
class Application extends Container implements ApplicationContract
{
    ...
    {
        return $this->basePath . DIRECTORY_SEPARATOR . 'dist' . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
    ...
    public function registerCoreContainerAliases()
    {
        foreach ([
            ...
            'events'               => [\Genesis\Events\Dispatcher::class, \Illuminate\Contracts\Events\Dispatcher::class],
            ...
            'request'              => [\Genesis\Http\Request::class, \Illuminate\Http\Request::class, \Symfony\Component\HttpFoundation\Request::class],
